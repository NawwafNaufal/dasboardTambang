    ...
    <>
        ...
        <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-1">
          <div className="flex items-center justify-between w-full h-11 gap-2 px-3 py-1 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-1">
            ...
            <button
              ...
              className="flex items-center justify-center w-10 h-10 rounded-xl text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 transition-colors lg:hidden"
            >
          ...
          {/* Desktop: ThemeToggle + UserDropdown */}
          <div className="hidden lg:flex items-center gap-2 2xsm:gap-3 mr-5">
            <ThemeToggleButton />
      ...
      {isApplicationMenuOpen && (
        <>
          {/* Backdrop */}
          <div
            className="fixed inset-0 z-[99997] bg-black/25 dark:bg-black/50 backdrop-blur-[2px] lg:hidden"
            onClick={toggleApplicationMenu}
          />

          {/* Panel */}
          <div
            className="fixed top-[58px] left-0 right-0 z-[99998] lg:hidden
          ...
          >
            ...
            <div className="px-3 pt-1.5 pb-2 space-y-2">
              ...
              {/* Dark Mode */}
              <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800/70 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                <div className="w-9 h-9 rounded-xl bg-indigo-50 dark:bg-indigo-500/20 flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-gray-800 dark:text-gray-100">Mode Gelap</p>
                  <p className="text-xs text-gray-400 dark:text-gray-500">Ubah tampilan tema</p>
                </div>
                <ThemeToggleButton />
              </div>
              ...
              {/* PT Selector */}
              <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800/70 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                <div className="w-9 h-9 rounded-xl bg-emerald-50 dark:bg-emerald-500/20 flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-gray-800 dark:text-gray-100">Lokasi PT</p>
                  <p className="text-xs text-gray-400 dark:text-gray-500 truncate">{selectedPT || "Pilih plant"}</p>
                </div>
              ...
              <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-gray-50 dark:bg-gray-800/70 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-gray-800 dark:text-gray-100">Aktivitas</p>
                  <p className="text-xs text-gray-400 dark:text-gray-500 truncate">
                    {isLoadingCurrent ? "Memuat..." : currentActivityDisplay}
                  </p>
                </div>
                {!isLoadingCurrent && currentList.length > 0 && (
                  <button
                    onClick={goToNext}
                    className="w-8 h-8 flex items-center justify-center rounded-xl bg-white dark:bg-gray-700 shadow-sm text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors flex-shrink-0"
                    aria-label="Next activity"
                  >
