  ...
  if (iconUrl) {
    return (
      <div
        ...
        style={isActive ? { backgroundColor: "#75b0f9" } : {}}
      >
        <img
          src={iconUrl}
          alt={activity}
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <p
                                    ...
                                    style={isCurrentAct ? { color: "#75b0f9" } : {}}
                                  >
                                    {formatActivityName(act)}
                                  </p>
                                  {isCurrentAct && (
                                    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" className="ml-auto flex-shrink-0" style={{ color: "#75b0f9" }}>
                          ...
                          {ptActivities.map((act) => {
                            ...
                            return (
                              <button
                                ...
                                style={isCur ? { backgroundColor: "#75b0f9" } : {}}
                              >
                                {/* Icon mobile */}
                                {(() => {
