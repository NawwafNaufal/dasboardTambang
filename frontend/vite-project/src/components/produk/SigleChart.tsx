...
const seriesData = [
  {
    name: "PA — Physical Availability",
    data: [7, 8, 15, 18, 12, 10, 14, 9, 11, 13, 16, 8],
    color: "#F87171", // merah/salmon
  },
  {
    name: "MA — Mechanical Availability",
    data: [6, 8, 10, 14, 9, 7, 12, 8, 10, 11, 13, 7],
    color: "#FCD34D", // kuning/cream
  },
  {
    name: "UA — Use of Availability",
    data: [5, 4, 5, 8, 6, 5, 7, 6, 5, 7, 9, 5],
    color: "#86EFAC", // hijau muda
  },
  {
    name: "EU — Effective Utilization",
    data: [4, 6, 8, 11, 7, 6, 9, 5, 7, 8, 10, 6],
    color: "#FCA5A5", // salmon muda
  },
];
