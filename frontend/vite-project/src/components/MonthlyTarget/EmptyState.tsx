...
export default function EmptyState({
  ...
  return (
    <div className="w-full h-full rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 p-5 transition-all duration-300 ease-in-out flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-4">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Belum ada data target bulanan untuk {selectedPT} di bulan{" "}
            {getMonthName(selectedMonth)} {currentYear}
          </p>
