...
export default function MonthlyTargetChart({
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center py-4">
      <div className="relative transition-all duration-300 ease-in-out w-full max-w-md mx-auto">
        <div className="w-full max-h-[330px] flex justify-center items-center" id="chartDarkStyle">
          {/* @ts-ignore */}
          <Chart
