  ...
  return (
    <div className="flex-1 flex flex-col justify-center">
      <div className="relative transition-all duration-300 ease-in-out">
        ...
        <span
          className={`absolute left-1/2 top-full -translate-x-1/2 -translate-y-[95%] rounded-full px-3 py-1 text-xs font-medium transition-all duration-300 ease-in-out ${
        ...
        >
          {currentData.deviation >= 0 ? "+" : ""}
          {currentData.deviation.toFixed(2)}%
        </span>
      </div>
      <div className="py-6">
